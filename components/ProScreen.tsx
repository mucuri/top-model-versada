...
const ProScreen: React.FC<ProScreenProps> = ({ onBack, t }) => {
    const [whatsapp, setWhatsapp] = useState('');

    const handlePlusSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        alert(t('alert_whatsapp_thanks', whatsapp));
        onBack();
    }
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white p-4">
            <header className="relative flex justify-center items-center mb-6">
                ...
                <h1 className="text-2xl font-bold">{t('pro_screen_plans_title')}</h1>
            </header>
            ...
            <main className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-400 mt-2">{t('pro_screen_subtitle')}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gray-800 border border-cyan-500/50 rounded-xl p-6 flex flex-col shadow-lg shadow-cyan-500/10">
                        ...
                        <p className="text-gray-400 mt-1 mb-4">{t('pro_screen_plus_payment')}</p>
                        
                        <div className="mb-4">
                            <p className="text-lg font-semibold">{t('pro_screen_plus_feature_title')}</p>
                            <p className="text-sm text-gray-400">{t('pro_screen_plus_feature_desc')}</p>
                        </div>

                        <form onSubmit={handlePlusSubmit} className="mt-auto">
                           <label htmlFor="whatsapp" className="text-sm font-medium text-gray-300">{t('pro_screen_plus_whatsapp_label')}</label>
                           <input
                             id="whatsapp"
                             type="tel"
                             value={whatsapp}
                    ...
                    <div className="bg-gray-800 border border-fuchsia-500/50 rounded-xl p-6 flex flex-col shadow-lg shadow-fuchsia-500/10">
                        ...
                        <p className="text-gray-400 mt-1 mb-4">{t('pro_screen_pro_subtitle')}</p>

                        <ul className="space-y-3 mb-6">
                            <li className="flex items-center">
                                <CheckCircleIcon className="w-5 h-5 text-fuchsia-400 mr-2"/> {t('pro_screen_pro_feature1')}
                            </li>
                            <li className="flex items-center">
                                <CheckCircleIcon className="w-5 h-5 text-fuchsia-400 mr-2"/> {t('pro_screen_pro_feature2')}
                            </li>
                            <li className="flex items-center">
                                <CheckCircleIcon className="w-5 h-5 text-fuchsia-400 mr-2"/> {t('pro_screen_pro_feature3')}
                            </li>
                             <li className="flex items-center">
                                <CheckCircleIcon className="w-5 h-5 text-fuchsia-400 mr-2"/> {t('pro_screen_pro_feature4')}
                            </li>
                        </ul>
                        
                        <div className="mt-auto">
                             <p className="text-center text-3xl font-bold mb-4">R$ 29,90<span className="text-lg font-normal text-gray-400">/{t('pro_screen_pro_monthly')}</span></p>
