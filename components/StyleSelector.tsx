  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 p-4">
      <div className="w-full max-w-2xl text-center">
        <h2 className="text-3xl font-bold text-white mb-2">Qual será o seu look?</h2>
        <p className="text-gray-400 mb-8">Descreva uma marca, um estilo, ou clique em uma das nossas sugestões.</p>
        ...
        <div className="mb-6">
            <input
              ...
              placeholder="Ex: 'Estilo futurista da Balenciaga com óculos neon'"
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-8">
            <span className="text-gray-400 text-sm self-center mr-2">Sugestões:</span>
